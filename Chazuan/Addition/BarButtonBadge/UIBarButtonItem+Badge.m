...
NSString const *shouldHideBadgeValueKey = @"shouldHideBadgeValueKey";

@implementation UIBarButtonItem (Badge)
@dynamic badgeValue, badgeBGColor, badgeTextColor, badgeFont;
@dynamic badgePadding, badgeMinSize, badgeOriginX, badgeOriginY;
@dynamic shouldHideBadgeAtZero, shouldAnimateBadge, shouldHideBadgeValue;
...
// Hide Badge Value
- (BOOL)shouldHideBadgeValue {
    NSNumber *number = objc_getAssociatedObject(self, &shouldHideBadgeValueKey);
    return number.boolValue;
}
- (void)setShouldHideBadgeValue:(BOOL)shouldHideBadgeValue
{
    NSNumber *number = [NSNumber numberWithBool:shouldHideBadgeValue];
    objc_setAssociatedObject(self, &shouldHideBadgeValueKey, number, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
