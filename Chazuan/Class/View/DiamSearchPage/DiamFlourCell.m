...
@interface DiamFlourCell ()

/// viewModel
@property (nonatomic, readwrite, strong) FlourItemViewModel *viewModel;
...
@implementation DiamFlourCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"DiamFlourCell";
    DiamFlourCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(FlourItemViewModel *)viewModel {
