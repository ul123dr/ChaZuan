...
@interface DiamShapeCell ()

/// viewModel
@property (nonatomic, readwrite, strong) ShapeItemViewModel *viewModel;
...
@implementation DiamShapeCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"DiamShapeCell";
    DiamShapeCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(ShapeItemViewModel *)viewModel {
...
- (void)_setup {
    ...
    self.shapeArr = @[@{@"val":@"Round",@"name":@"圆形",@"image":@"yuan_shape",@"selImage":@"yuan_shape_blue"},
                      ...
                      @{@"val":@"Other",@"name":@"阿斯切",@"image":@"other_shape",@"selImage":@"other_shape_blue"},
                      ...
                      @{@"val":@"Marquise",@"name":@"other",@"image":@"ma_shape",@"selImage":@"ma_shape_blue"}];
}
