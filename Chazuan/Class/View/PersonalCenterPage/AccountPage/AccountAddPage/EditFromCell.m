...
@interface EditFromCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditFromItemViewModel *viewModel;
...
@implementation EditFromCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditFromCell";
    EditFromCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditFromItemViewModel *)viewModel {
