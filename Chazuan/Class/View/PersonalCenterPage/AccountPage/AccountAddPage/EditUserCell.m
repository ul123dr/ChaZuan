...
@interface EditUserCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditUserItemViewModel *viewModel;
...
@implementation EditUserCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditUserCell";
    EditUserCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditUserItemViewModel *)viewModel {
