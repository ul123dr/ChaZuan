...
@interface EditBuyerCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditBuyerItemViewModel *viewModel;
...
@implementation EditBuyerCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditBuyerCell";
    EditBuyerCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditBuyerItemViewModel *)viewModel {
