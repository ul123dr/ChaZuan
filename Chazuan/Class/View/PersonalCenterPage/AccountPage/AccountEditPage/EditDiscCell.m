...
@interface EditDiscCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditDiscItemViewModel *viewModel;
...
@implementation EditDiscCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditDiscCell";
    EditDiscCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditDiscItemViewModel *)viewModel {
