...
@interface EditFancyCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditFancyItemViewModel *viewModel;
...
@implementation EditFancyCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditFancyCell";
    EditFancyCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditFancyItemViewModel *)viewModel {
