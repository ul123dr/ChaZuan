...
@interface EditRealCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditRealItemViewModel *viewModel;
...
@implementation EditRealCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditRealCell";
    EditRealCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditRealItemViewModel *)viewModel {
