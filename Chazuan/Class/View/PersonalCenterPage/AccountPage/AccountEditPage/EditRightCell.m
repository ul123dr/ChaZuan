...
@interface EditRightCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditRightItemViewModel *viewModel;
...
@implementation EditRightCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditRightCell";
    EditRightCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditRightItemViewModel *)viewModel {
