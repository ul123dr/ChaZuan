...
@interface EditSellerCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditSellerItemViewModel *viewModel;
...
@implementation EditSellerCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditSellerCell";
    EditSellerCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditSellerItemViewModel *)viewModel {
