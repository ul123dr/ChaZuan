...
@interface EditUsertypeCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditUsertypeItemViewModel *viewModel;
...
@implementation EditUsertypeCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditUsertypeCell";
    EditUsertypeCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditUsertypeItemViewModel *)viewModel {
