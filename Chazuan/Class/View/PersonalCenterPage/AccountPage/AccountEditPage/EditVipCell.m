...
@interface EditVipCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditVipItemViewModel *viewModel;
...
@implementation EditVipCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditVipCell";
    EditVipCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditVipItemViewModel *)viewModel {
