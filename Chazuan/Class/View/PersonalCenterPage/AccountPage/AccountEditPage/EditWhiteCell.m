...
@interface EditWhiteCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditWhiteItemViewModel *viewModel;
...
@implementation EditWhiteCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditWhiteCell";
    EditWhiteCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditWhiteItemViewModel *)viewModel {
