...
@interface EditZtCell ()

// viewModel
@property (nonatomic, readwrite, strong) EditZtItemViewModel *viewModel;
...
@implementation EditZtCell

#pragma mark - Public Method
+ (instancetype)cellWithTableView:(UITableView *)tableView style:(UITableViewCellStyle)style {
    static NSString *ID = @"EditZtCell";
    EditZtCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) cell = [[self alloc] initWithStyle:style reuseIdentifier:ID];;
    return cell;
}

- (void)bindViewModel:(EditZtItemViewModel *)viewModel {
