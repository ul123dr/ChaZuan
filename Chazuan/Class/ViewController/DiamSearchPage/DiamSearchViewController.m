...
#import "DiamSearchViewController.h"
#import "SearchBottomView.h"
#import <YCMenuView.h>
#import "DiamHeaderView.h"
#import "DiamFooterView.h"

@interface DiamSearchViewController ()

@property (nonatomic, readwrite, strong) DiamSearchViewModel *viewModel;
@property (nonatomic, readwrite, strong) SearchBottomView *bottomView;

@end

@implementation DiamSearchViewController
...
- (void)_shopSizePopView:(ZGButton *)btn {
    NSMutableArray *items = [NSMutableArray array];
    for (int i = 0; i < self.viewModel.sizeArray.count; i++) {
        NSString *title = self.viewModel.sizeArray[i];
